...
#node.override['auth']['pw_max_age'] = 60
...
node.override['auth']['allow_homeless'] = false
...
node.override['security']['suid_sgid']['remove_from_unkown'] = false
node.override['security']['suid_sgid']['dry_run_on_unkown'] = false
